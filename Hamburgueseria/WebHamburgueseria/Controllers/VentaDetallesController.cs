...
namespace WebHamburgueseria.Controllers
{
    public class VentaDetallesController : Controller
    {
        ...
        public VentaDetallesController(LabHamburgueseriaContext context)
        {
            _context = context;
        }
        ...
        {
            var labHamburgueseriaContext = _context.VentaDetalles.Where(x => x.Estado != -1).Include(v => v.IdProductoNavigation).Include(v => v.IdVentaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdDetalleVenta,IdVenta,IdProducto,PrecioVenta,Cantidad,SubTotal,UsuarioRegistro,FechaRegistro,Estado")] VentaDetalle ventaDetalle)
        {
            ...
            ViewData["IdVenta"] = new SelectList(_context.Venta, "IdVenta", "IdVenta", ventaDetalle.IdVenta);
            return View(ventaDetalle);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDetalleVenta,IdVenta,IdProducto,PrecioVenta,Cantidad,SubTotal,UsuarioRegistro,FechaRegistro,Estado")] VentaDetalle ventaDetalle)
        {
